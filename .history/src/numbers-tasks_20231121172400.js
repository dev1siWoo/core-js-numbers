...
function toExponential(number, fractionDigits) {
  ...
  const exp = Math.floor(Math.log10(Math.abs(inputNumber)));
  inputNumber = inputNumber / Math.pow(10, exp);

  inputNumber = inputNumber.toFixed(fractionDigits);

  return inputNumber + 'e' + exp;
}
